...
const ProfileLinksContainer = () => 
{
    ...
    <a href="https://v-k.pw/iIFifg" className="flex flex-row justify-center" alt="linkedin">
        <div className="flex flex-row p-3 border rounded-full border-slate-800 justify-self-center hover:bg-slate-900">
    ...
    <a href="https://v-k.pw/fEvdT2" className="flex flex-row justify-center" alt="github">
        <div className="flex flex-row p-3 border border-slate-800 rounded-full justify-self-center hover:bg-slate-900">
    ...
    <a href="mailto:viditkhandelwal_2023@depauw.edu" className="flex flex-row justify-center" alt="email"><div className="flex flex-row p-3 border rounded-full border-slate-800 hover:bg-slate-900">
    ...
    <a href="https://v-k.pw/Et6v46" className="flex flex-row justify-center" alt="email"><div className="flex flex-row p-3 border rounded-full border-slate-800 hover:bg-slate-900">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="white" className="self-center bi bi-medium" viewBox="0 0 16 16">
