...
{
    return (<div id="socials" class="flex flex-row justify-center space-x-3">
    <a href="https://v-k.pw/iIFifg" class="flex flex-row justify-center" alt="linkedin">
        <div class="flex flex-row p-3 border rounded-full border-slate-800 justify-self-center hover:bg-slate-900">
    ...
    <a href="https://v-k.pw/fEvdT2" class="flex flex-row justify-center" alt="github">
        <div class="flex flex-row p-3 border border-slate-800 rounded-full justify-self-center hover:bg-slate-900">
    ...
    <a href="mailto:viditkhandelwal_2023@depauw.edu" class="flex flex-row justify-center" alt="email"><div class="flex flex-row p-3 border rounded-full border-slate-800 hover:bg-slate-900">
    ...
    <a href="https://v-k.pw/Et6v46" class="flex flex-row justify-center" alt="email"><div class="flex flex-row p-3 border rounded-full border-slate-800 hover:bg-slate-900">
        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="white" class="self-center bi bi-medium" viewBox="0 0 16 16">
    ...
    <a href="https://v-k.pw/93sU6E" class="flex flex-row justify-center" target="_blank" alt="email"><div class="flex flex-row p-3 border rounded-full border-slate-800 hover:bg-slate-900">
        <svg width="20" height="20" viewBox="0 0 250 250" fill="none" class="self-center" xmlns="http://www.w3.org/2000/svg">
